...
from utils import seed_everything, fixations2seq, get_args_parser_train, save_model_train, get_args_parser_test, get_args_parser_everything
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Gazeformer Train', parents=[get_args_parser_everything()])
